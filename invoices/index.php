...
if (isset($_GET['search']) && !empty($_GET['search'])) {
    $search = '%' . $_GET['search'] . '%';
    $where .= " AND (Numero_Facture LIKE :search OR Notes LIKE :search)";
    ...
    <div class="flex-1 overflow-auto p-6">
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="create_facture.php" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div class="mb-6 p-4 bg-gray-50 rounded-md">
                ...
                <form method="GET" action="" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div>
                        ...
                        <input type="text" id="search" name="search" placeholder="Numéro ou notes..." 
                    ...
                    <div>
                        ...
                        <select id="client" name="client" 
                            ...
                            <?php foreach ($clients as $client): ?>
                                <?php $selected = (isset($_GET['client']) && $_GET['client'] == $client['id']) ? 'selected' : ''; ?>
                    ...
                    <div class="md:col-span-2 flex items-end">
                        ...
                        <a href="factures.php" class="px-4 py-2 bg-gray-500 text-white rounded-md hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500">
                            Réinitialiser
                        </a>
                    </div>
                </form>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex space-x-2">
                                            ...
                                            <?php if ($facture['Statut_Facture'] === 'En attente'): ?>
                                                <a href="factures.php?mark_paid=<?php echo $facture['id']; ?>" class="text-green-600 hover:text-green-900" title="Marquer comme payée" onclick="return confirm('Marquer cette facture comme payée?');">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                                    </svg>
                                                </a>
                                            <?php endif; ?>
                                            <a href="edit.php?id=<?php echo $facture['id']; ?>" class="text-indigo-600 hover:text-indigo-900" title="Modifier">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
