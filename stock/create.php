...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    } else if (!preg_match('/^[A-Z]{3}-\d{4}$/', $_POST['reference'])) {
        $errors['reference'] = 'Format de référence invalide (XXX-0000)';
    }
    ...
    if (empty($_POST['tva'])) {
        $errors['tva'] = 'Le taux de TVA est requis';
    }
            ...
            <form id="article-form" method="POST" action="">
                ...
                <div class="mb-6 p-4 bg-gray-50 rounded-md border-l-4 border-blue-500">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" id="reference" name="reference" placeholder="Ex: ABC-1234" required
                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                value="<?php echo isset($_POST['reference']) ? htmlspecialchars($_POST['reference']) : ''; ?>">
                            <span class="text-xs text-gray-500 mt-1 block">Format: XXX-0000 (3 lettres majuscules suivies de 4 chiffres)</span>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        <div>
                            ...
                            <select id="categorie" name="categorie" required
                                ...
                                <?php
                                $categories = [
                                    'Pièces moteur', 'Transmission', 'Freinage', 'Suspension', 
                                    'Carrosserie', 'Électricité', 'Accessoires', 'Outillage', 
                                    'Lubrifiants', 'Pneus'
                                ];
                ...
                <div class="mb-6 p-4 bg-gray-50 rounded-md border-l-4 border-blue-500">
                        ...
                        <div>
                            ...
                            <select id="tva" name="tva" required
                                ...
                                foreach ($taux_tva as $taux) {
                                    $selected = (isset($_POST['tva']) && $_POST['tva'] == $taux) ? 'selected' : '';
                                    echo "<option value=\"$taux\" $selected>$taux%</option>";
                                }
                                ?>
                            </select>
                            <?php if (isset($errors['tva'])): ?>
                                <div class="text-red-500 text-xs mt-1"><?php echo $errors['tva']; ?></div>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        ...
                        <div>
                            <label for="prix_vente_ttc" class="block text-sm font-medium text-gray-700 mb-1">Prix de vente (€ TTC)</label>
                            <input type="number" id="prix_vente_ttc" name="prix_vente_ttc" step="0.01" min="0" readonly
                                class="w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-md">
                            <span class="text-xs text-gray-500 mt-1 block">Calculé automatiquement</span>
                        </div>
                    </div>
...
<script>
    ...
    function setupPriceCalculations() {
        ...
        const prixVenteTtcInput = document.getElementById('prix_vente_ttc');
        ...
        tvaSelect.addEventListener('change', calculatePrices);
    ...
    function setupValidation() {
        ...
        const fields = {
            reference: {
                required: true,
                pattern: /^[A-Z]{3}-\d{4}$/,
                errorMsg: 'Format requis: XXX-0000 (3 lettres majuscules suivies de 4 chiffres)'
            },
            designation: {
                required: true,
                minLength: 3,
            ...
            tva: {
                required: true,
                errorMsg: 'Veuillez sélectionner un taux de TVA'
            },
            quantite_stock: {
                required: true,
                min: 0,
        ...
        function validateField(fieldName, value) {
            ...
            if (!errorElement) {
                ...
                document.getElementById(fieldName).parentNode.appendChild(errorElement);
            }
    ...
    function setupFormActions() {
        ...
        previewBtn.addEventListener('click', function() {
            ...
            for (const [key, value] of formData.entries()) {
                ...
                if (key === 'prix_vente_ht' || key === 'prix_vente_ttc') continue;
            ...
            const prixVenteTtc = document.getElementById('prix_vente_ttc').value;
            ...
            tableHTML += `<tr><td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Prix de vente (€ TTC)</td><td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">${prixVenteTtc}</td></tr>`;
            ...
            for (const [key, value] of formData.entries()) {
                ...
                if (key === 'prix_achat' || key === 'marge_benifice' || key === 'tva' || 
            ...
            fieldNames.push('prix_vente_ttc');
            values.push(prixVenteTtc);
        ...
        resetBtn.addEventListener('click', function() {
            ...
            document.getElementById('prix_vente_ht').value = '';
    ...
    function showStatus(message, type) {
        ...
        if (!statusContainer) {
            ...
            document.querySelector('.bg-white').insertBefore(statusContainer, document.getElementById('article-form-container'));
        }
